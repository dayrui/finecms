...
CREATE TABLE `{pre}category` (
  ...
  `content` mediumtext DEFAULT NULL COMMENT '单网页内容',
...
CREATE TABLE `{pre}content_1` (
  ...
  `modelid` smallint(5) NOT NULL,
  `title` varchar(80) DEFAULT NULL DEFAULT '',
  `thumb` varchar(255) DEFAULT NULL DEFAULT '',
  `keywords` char(40) DEFAULT NULL DEFAULT '',
